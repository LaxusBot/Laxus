...
// Utility name
private const val UTIL_NAME = "BodyHandlerUtil"

private val log = createLogger("xyz.laxus.wyvern.internal.$UTIL_NAME")
...
// marked internal, we might require this later in other parts of code
...
internal fun handleReturns(api: API, context: CallContext, value: Any?) {
    // should we bother?
    if(value !== null) {
