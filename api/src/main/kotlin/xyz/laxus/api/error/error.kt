...
// 403 - Forbidden
fun forbidden(message: String) = createHttpErrorWithMessage(HttpStatusCode.Forbidden, message)
...
private fun createHttpErrorWithMessage(code: HttpStatusCode, message: String?): HttpError {
