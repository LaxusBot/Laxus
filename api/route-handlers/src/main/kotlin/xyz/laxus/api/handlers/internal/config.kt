...
internal fun Value.getLongList() = getList().map { it.toLongOrNull() }

internal fun Value.getClass(classLoader: ClassLoader? = null) = loadClass(getString(), classLoader)
internal fun Value.getClassList(classLoader: ClassLoader? = null) = getList().map { loadClass(getString(), classLoader) }
