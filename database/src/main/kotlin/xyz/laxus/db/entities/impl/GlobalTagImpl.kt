 ...
 */
internal data class GlobalTagImpl(
    override val name: String,
    override var content: String,
    override var ownerId: Long?
): Tag {
    private var deleted = false
    override val isGlobal get() = true
    ...
    override fun edit(newContent: String) {
        checkDeleted()
        content = newContent
        DBGlobalTags.updateTag(this)
    }

    override fun delete() {
        checkDeleted()
        DBGlobalTags.deleteTag(name)
        deleted = true
    }
    ...
    override fun override() {
        checkDeleted()
        ownerId = null
        DBGlobalTags.overrideTag(this)
    }

    private fun checkDeleted() = check(!deleted) { "Deleted tag cannot be modified!" }
}