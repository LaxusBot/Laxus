...
import net.dv8tion.jda.core.requests.ErrorResponse.UNKNOWN_MESSAGE
...
import xyz.laxus.bot.utils.commandArgs
import xyz.laxus.bot.utils.jda.await
import xyz.laxus.bot.utils.jda.embed
import xyz.laxus.bot.utils.jda.formattedName
...
class QuoteCommand: Command(StandardGroup) {
    ...
    override suspend fun execute(ctx: CommandContext) {
        ...
        when(split.size) {
            ...
            2 -> {
                channel = try {
                    ctx.guild.getTextChannelById(split[0].toLong())
        ...
        ctx.reply(embed {
            author {
                this.value = message.author.formattedName
